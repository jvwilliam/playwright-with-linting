...
test.describe('Homepage Smoke Test', { tag: '@smoke' }, () => {
  ...
  test(
    'Check the correct landing page is loaded.',
    {
      annotation: [
        {
          type: 'Description',
          description:
            'Verifies that we are redirected to the correct landing page by comparing the page title and url from the expected values.',
        },
      ],
    },
